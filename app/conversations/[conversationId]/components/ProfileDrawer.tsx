                                        ...
                                        <div className="px-4 sm:px-6">
                                            <div className="flex items-start justify-end">
                                                <div className="ml-3 flex h-7 items-center">
                                                    <button onClick={onClose} type="button" className="rounded-md bg-white text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
                                            ...
                                            <div className="flex flex-col items-center">
                                                ...
                                                <div className="flex gap-10 my-8">
                                                    <div className="flex flex-col gap-3 items-center cursor-pointer hover:opacity-75" onClick={() => {}}>
                                                        <div className="w-10 h-10 ng-neutral-100 rounded-full flex items-center justify-center ">
                                                            <IoTrash size={20}/>
                                                        </div>
                                                ...
                                                <div className="w-full pb-5 pt-5 sm:px-0 sm:pt-0">
                                                    <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                        {!data.isGroup && (
                                                            <div>
                                                                <dl className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">Email</dl>
